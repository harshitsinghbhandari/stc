...
gh api repos/harshitsinghbhandari/stc/pulls/<num>/reviews \
  --jq '.[] | {author: .user.login, state: .state, body: .body}'

# 3. Commentaires inline (si CHANGES_REQUESTED)
gh api repos/harshitsinghbhandari/stc/pulls/<num>/comments \
...
```
**PR #<num>** — https://github.com/harshitsinghbhandari/stc/pull/<num>
