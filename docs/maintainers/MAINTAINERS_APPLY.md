...
1. Open a discussion in [harshitsinghbhandari/stc Maintainers Applications · Discussions · GitHub](https://github.com/harshitsinghbhandari/stc/discussions/categories/maintainers-applications) titled **Maintainer Application: [Your GitHub Handle]**
